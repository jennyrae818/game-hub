...
const gameSeeds = [
    ...
    },
    {
        ...
        usersPlaying: 0,
        categories: [categorySeeds[0]._id, categorySeeds[4]._id]
    },
    {
        gameName: "Pac-Man",
        ...
        usersPlaying: 0,
        categories: categorySeeds[1]._id
    },
    {
        gameName: "Cribbage",
        ...
        usersPlaying: 0,
        categories: [categorySeeds[2]._id, categorySeeds[3]._id]
    },
    {
        ...
        usersPlaying: 0,
        categories: categorySeeds[2]._id
    },
    {
        gameName: "Eucher",
        ...
        usersPlaying: 0,
        categories: categorySeeds[3]._id
    },
    {
    ...
    },
    {
        ...
        usersPlaying: 0,
        categories: [categorySeeds[4]._id, categorySeeds[0]]
    },
    {
        gameName: "Pokemon",
        ...
        usersPlaying: 0,
        categories: categorySeeds[5]._id
    },
];
